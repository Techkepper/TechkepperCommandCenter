  ...
  es: {
    collaborators: {
      ...
      table: {
        ...
        empty: "No hay colaboradores para mostrar.",
      },
      tooltips: {
  ...
  en: {
    collaborators: {
      ...
      table: {
        ...
        noEmail: "No email",
        noPhone: "No phone",
        empty: "There are no collaborators to display.",
      },
      tooltips: {
      ...
      install: {
        ...
        description:
          "The Collaborators module requires running the included migration.",
      },
      toasts: {
  ...
  pt: {
    collaborators: {
      ...
      table: {
        ...
        empty: "Não há colaboradores para exibir.",
      },
      tooltips: {
      ...
      install: {
        ...
        description:
          "O módulo Colaboradores requer a execução da migração incluída.",
      },
      toasts: {
        created: "Colaborador criado com sucesso.",
