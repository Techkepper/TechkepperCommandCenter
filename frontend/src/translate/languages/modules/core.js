  ...
  es: {
    ...
    settings: {
      operational: {
        ...
        subtitle: "Identidad, asignaciones automáticas y acceso a reportes.",
        ...
        note: "La asignación nunca se revierte si falla el envío. El resultado queda registrado en la auditoría interna de la conversación.",
  ...
  en: {
    ...
    settings: {
      operational: {
        ...
        templateHelp:
          "Variables: {NOMBRE_AGENTE}, {NOMBRE_CLIENTE}, {DEPARTAMENTO}, {EMPRESA}, {HORARIO_ATENCION}",
        note: "The assignment is never reverted if sending fails. The result is recorded in the conversation's internal audit log.",
  ...
  pt: {
    ...
    settings: {
      operational: {
        ...
        subtitle: "Identidade, atribuições automáticas e acesso a relatórios.",
        ...
        note: "A atribuição nunca é revertida se o envio falhar. O resultado fica registrado na auditoria interna da conversa.",
